...
dw 0xAA55 
; This directive places the hexadecimal value 0xAA55 at the end of the 512-byte boot sector.
; This is the **boot signature** required by the BIOS. The BIOS checks for this specific value at the last two bytes of the sector to determine if it is a valid bootable sector.
